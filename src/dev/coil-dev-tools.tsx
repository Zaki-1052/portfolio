    ...
    'coil growth': folder(
      {
        ...
        beadDome: { value: initial.beadDome, min: 0, max: 0.25, step: 0.01 },
        jitter: { value: initial.jitter, min: 0, max: 0.4, step: 0.005 },
        radiusJitter: { value: initial.radiusJitter, min: 0, max: 0.3, step: 0.01 },
    ...
    'coil look': folder(
      {
        ...
        strandRadius: { value: initial.strandRadius, min: 0.015, max: 0.08, step: 0.005 },
        helixRadius: { value: initial.helixRadius, min: 0.03, max: 0.14, step: 0.005 },
        twistPitch: { value: initial.twistPitch, min: 0.6, max: 5, step: 0.1 },
        linkerWidthScale: { value: initial.linkerWidthScale, min: 0.3, max: 1, step: 0.05 },
        rungRadius: { value: initial.rungRadius, min: 0.005, max: 0.04, step: 0.001 },
        rungSpacing: { value: initial.rungSpacing, min: 0.4, max: 3, step: 0.05 },
        ...
        wrapTurns: { value: initial.wrapTurns, min: 1, max: 3.5, step: 0.05 },
