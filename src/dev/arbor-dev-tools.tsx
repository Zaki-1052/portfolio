    ...
    'arbor growth': folder(
      {
        ...
        trunkLength: { value: initial.trunkLength, min: 2, max: 12, step: 0.1 },
        ...
        fineSplits: { value: initial.fineSplits, min: 1.8, max: 3, step: 0.1 },
    ...
    'arbor look': folder(
      {
        ...
        pulseSpeed: { value: initial.pulseSpeed, min: 0, max: 0.4, step: 0.005 },
        pulseGain: { value: initial.pulseGain, min: 0, max: 3, step: 0.05 },
        hubGlowA: { value: initial.hubGlowA },
        hubGlowB: { value: initial.hubGlowB },
        hubGlowStrength: { value: initial.hubGlowStrength, min: 0, max: 3, step: 0.05 },
        hubBump: { value: initial.hubBump, min: 0, max: 1.2, step: 0.02 },
        sheathColor: { value: initial.sheathColor },
        sheathAmount: { value: initial.sheathAmount, min: 0, max: 1, step: 0.02 },
        punctaSize: { value: initial.punctaSize, min: 0.1, max: 0.9, step: 0.01 },
