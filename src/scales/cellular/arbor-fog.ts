...
//   · a density delta — a rose mist that peaks just after the band handoff
//     (the tree resolves OUT of it) and clears across the orbital sweep;
//   · a color blend toward the band's rose fog anchor, sustained through the
...
/** Sustained rose strength through the index beat. */
export const FOG_ARBOR_ROSE_MAX = 0.65;

/** Deep rose-plum the scene fog leans toward while the arbor owns the band. */
export const ARBOR_FOG_ROSE = '#3d2733';
